-- CREATE DATABASE usr6242590_kunkaibookshop CHARACTER SET utf8 COLLATE utf8_general_ci;     
CREATE DATABASE usr6242590_kunkaibookshop CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;     
USE usr6242590_kunkaibookshop;                                      
CREATE TABLE users(    
  ...
  KEY (FirstName, LastName, Email, UStatus)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `users` (`UserID`, `FirstName`, `LastName`, `Email`, `UserPassword`, `Sex`, `Phone`, `UStatus`) VALUES
(1, 'ศรัณย์', 'เวียงสิมมา', 'singtopza@hotmail.com', 'fb0e22c79ac75679e9881e6ba183b354', 'ชาย', '0611230387', 'Admin'),
(2, 'ศรัณย์', 'เวียงสิมมา', 'cyberlab24244@hotmail.com', 'fb0e22c79ac75679e9881e6ba183b354', 'ชาย', '0611230387', 'Member'),
(3, 'Saran', 'Wringsimma', 'nongtopkup@hotmail.com', '4148303ae802b15662de54143dab91a3', 'ชาย', '0611230387', 'Member'),
(4, 'สุดหล่อ', 'ห่อหมก', '624259027@webmail.npru.ac.th', 'fb0e22c79ac75679e9881e6ba183b354', 'ชาย', '0971559310', 'Officer'),
(5, 'tom', 'mouoma', 'planes_29@hotmail.com', '6c3152031a1baef9b928f6a9bb6782f6', 'หญิง', '099626445', 'Member'),
(6, 'ศราวุธ ', 'เวียงสิมมา', 'tank_tank411@hotmail.com', '4a0504f71e26db83bbae654c5614b0b6', 'ชาย', '0960328952', 'Member');

CREATE TABLE booktype(  
  BookType_id int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  BookType_group varchar(50) NOT NULL,
  BookType_name varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `booktype` (`BookType_id`, `BookType_group`, `BookType_name`) VALUES
(1, 'ไม่พบ', 'ไม่พบ'),
(2, 'การศึกษา', 'คณิตศาสตร์'),
(3, 'การศึกษา', 'ภาษาไทย'),
(4, 'การศึกษา', 'ประวัติศาสตร์'),
(5, 'การศึกษา', 'อัตชีวประวัติ ชีวประวัติ'),
(6, 'การศึกษา', 'วิทยาการและเทคโนโลยี'),
(7, 'ความรู้ทั่วไป', 'วรรณกรรม'),
(8, 'ความรู้ทั่วไป', 'การบริหาร'),
(9, 'ความรู้ทั่วไป', 'การพัฒนาตนเอง'),
(10, 'ความรู้ทั่วไป', 'การ์ตูน'),
(11, 'ความรู้ทั่วไป', 'การท่องเที่ยว'),
(12, 'ความรู้ทั่วไป', 'อาหารและสุขภาพ'),
(13, 'ความรู้ทั่วไป', 'การเกษตรและธรรมชาติ'),
(14, 'ความรู้ทั่วไป', 'ครอบครัว');

CREATE TABLE books(  
  BookNumber int(20) NOT NULL AUTO_INCREMENT, 
  BookISBN varchar(20) NOT NULL PRIMARY KEY, 
  BookImg1 varchar(255) NOT NULL,
  BookImg2 varchar(255) NOT NULL,
  BookImg3 varchar(255) NOT NULL,
  BookName varchar(100) NOT NULL,
  BookStar float(4) NOT NULL,
  BookSell varchar(10) NOT NULL,
  BookPrice float(10) NOT NULL,
  BookFullPrice float(10) NOT NULL,
  BookAuthor varchar(50) NOT NULL,
  BookTranslate varchar(50) NOT NULL,
  BookStock varchar(255) NOT NULL,
  BookScript text(65534) NOT NULL,
  BookCover varchar(10) NOT NULL,
  BookPage varchar(5) NOT NULL,
  BookSizeW varchar(5) NOT NULL,
  BookSizeL varchar(5) NOT NULL,
  BookSizeH varchar(5) NOT NULL,
  BookWeight varchar(5) NOT NULL,
  BookColor varchar(10) NOT NULL,
  BookPaper varchar(20) NOT NULL,
  BookInstitution varchar(50) NOT NULL,
  BookYear varchar(15) NOT NULL,
  BookOriginalName varchar(50) NOT NULL,
  BookOriginalInstitution varchar(50) NOT NULL,
  BookType int(10) NOT NULL,
  KEY (BookNumber, BookType),
  CONSTRAINT fk_booktypeid FOREIGN KEY (BookType) REFERENCES booktype(BookType_id)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `books` (`BookNumber`, `BookISBN`, `BookImg1`, `BookImg2`, `BookImg3`, `BookName`, `BookStar`, `BookSell`, `BookPrice`, `BookFullPrice`, `BookAuthor`, `BookTranslate`, `BookStock`, `BookScript`, `BookCover`, `BookPage`, `BookSizeW`, `BookSizeL`, `BookSizeH`, `BookWeight`, `BookColor`, `BookPaper`, `BookInstitution`, `BookYear`, `BookOriginalName`, `BookOriginalInstitution`, `BookType`) VALUES
(2, '9786161826567', '9786161826567-01', '', '', 'เลิกเป็นคนดี แล้วจะมีความสุข', 4, '1146', 225, 213.75, '(Tokio Godo) โกะโด โทคิโอะ', 'อาคิรา รัตนาภิรัต', '1950', 'ทุกคนต้องการเป็นที่ชื่นชอบและได้รับการยอมรับกันทั้งนั้น แต่บางคนก็แคร์สายตาคนอื่นมากไปจนไม่เป็นตัวของตัวเอง สุดท้ายก็กดดันและเป็นทุกข์.. \'เลิกเป็นคนดี แล้วจะมีความสุข\' จะช่วยให้คุณกล้าเป็นตัวเองมากขึ้น และแคร์สายตาคนอื่นน้อยลง เช่น เลิกกลัวการถูกเกลียด เลิกเปลี่ยนตัวเองให้เข้ากับคนอื่น และเลิกเกรงใจจนเกินเหตุ เป็นต้น', 'ปกอ่อน', '182', '146', '211', '11', '235', '2 สี', 'กระดาษถนอมสายตา', 'อมรินทร์ How To, สนพ.', '2018', '\'Ii Hoto\' wo Yamereba Jinsei wa Umaku Iku', 'Nippon Jitsugyo Publishing Co.,Ltd.', 9),
(1, '9786161830342', '9786161830342-01', '', '', 'เราทุกคนล้วนมีร้านเวทมนตร์อยู่ในใจ', 5, '2124', 232.75, 245, 'James R. Doty, M.D. (เจมส์ อาร์. โดตี, ดร.)', 'นพ. นที สาครยุทธเดช', '19946', 'เรื่องราวของ \"จิม โดตี้\" เด็กชายที่เติบโตในทะเลทรายของแคลิฟอร์เนีย ในครอบครัวที่ผุพัง พ่อติดเหล้า แม่เป็นโรคซึมเศร้าและอัมพาต ในวันหนึ่งที่ชีวิตมืดแปดด้าน เด็กชายจิมในวัย 12 ปี เดินเข้าไปในร้านขายของมายากลแห่งหนึ่งเพื่อซึ้อปลอกนิ้วพลาสติก แต่กลับได้พบกับผู้หญิงคนหนึ่งนามว่า \"รูธ\" ผู้สอนเทคนิคให้เขาก้าวข้ามความเจ็บปวด และใช้พลังของสมองและหัวใจเปลี่ยนชีวิตให้พบสิ่งมหัศจรรย์ จนจิมได้กลายมาเป็นศาสตราจารย์และแพทย์ที่มีชื่อเสียง ของมหาวิทยาลัยสแตนฟอร์ด\r\n', 'ปกอ่อน', '232', '146', '210', '12', '300', '2 สี', 'กระดาษถนอมสายตา', 'อมรินทร์ How To, สนพ.', '2019', 'Into The Magic Shop', 'Avery, an imprint of Penguin Publishing Group', 9),
(3, '9786161834043', '9786161834043-01', '', '', '12 กฎที่ใช้ได้ตลอดชีวิต : 12 Rules For Life', 4, '5512', 375.25, 395, 'Jordan B. Peterson (จอร์แดน บี ปีเตอร์สัน)', 'ธีร์ ทิพกฤต', '0', 'อะไรคือสิ่งสำคัญในการจะมีชีวิตที่ดีและมีความหมาย จอร์แดน บี. ปีเตอร์สัน ศาสตราจารย์ด้านจิตวิทยาผู้ทรงอิทธิพลที่สุดในโลกตะวันตก จากมหาวิทยาลัยโทรอนโตและฮาร์วาร์ด ได้ผสานศาสตร์และศิลป์อันล้ำลึก ของขนบธรรมเนียมแต่โบราณของมนุษยชาติ กับการค้าพบทางวิทยาศาสตร์อันน่าทึ่งของโลกยุคใหม่ นำเสนอกฎทรงพลัง 12 ประการ ที่จะยกระดับชีวิตของทุกคนให้พ้นจากวังวนของปัญหา และความสับสนวุ่นวายใด ๆ ก็ตามของชีวิตปีเตอร์สันเปิดเผยความจริงของการเป็นมนุษย์ที่คุณต้องตกตะลึงผ่านคำถาม ระบบประสาทของสัตว์ชั้นอาทิ ระบบประสาทของสัตว์ชั้นต่ำอย่างล็อบสเตอร์บอกอะไรเรา เรื่องการยืนให้ตัวตรงอกผายไหล่ผึ่งและความสำเร็จในชีวิต 12 กฎที่ใช้ได้ตลอดชีวิต คือขุมปัญญาที่นำไปใช้ได้จริงและทันที เพื่อที่คุณจะพบความมหัศจรรย์ของจิตวิญญาณมนุษย์ และพลังเปลี่ยนแปลงชีวิตที่ไม่มีวันหมดสิ้น ภายในตัวของคุณเอง!', 'ปกอ่อน', '476', '146', '210', '25', '595', 'ขาวดำ', 'กระดาษถนอมสายตา', 'อมรินทร์ How To, สนพ.', '2/20', '12 Rules For Life', 'CookeMcDermid Agecy,', 9),
(4, '9786162873829', '9786162873829-01', '', '', 'อย่าเป็นคนเก่งที่คุยไม่เป็น', 3, '730', 209, 209, 'Tadashi Yasuda (ทาดาชิ ยาซุดะ)', 'ช่อลดา เจียมวิจักษณ์', '0', 'ไม่ว่าคุณจะทำงานอะไร ประกอบอาชีพไหน เมื่อถึงจุดหนึ่งจะมี บางสิ่ง ที่สำคัญแซงหน้าความรู้ความสามารถ หากขาดมันไป ต่อให้คุณพยายามทุ่มเทมากเพียงใด คุณก็จะประสบความสำเร็จแบบครึ่ง ๆ กลาง ๆ ไปได้ไม่ไกลอย่างที่คาดหวังไว้ สิ่งนั้นคือ ทักษะคุยเล่น', 'ปกอ่อน', '232', '128', '185', '14', '225', 'ขาวดำ', 'กระดาษถนอมสายตา', 'วีเลิร์น, สนพ.', '-', 'Chou Ichiryuu no Zatsudanryoku', 'Bunkyosha Co., Ltd.', 9);
...
CREATE TABLE bookcategory(
  ...
  KEY (BookCategoryID, CategoryID, BookISBN),
  CONSTRAINT fk_CategoryID FOREIGN KEY (CategoryID) REFERENCES category(CategoryID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT,
  CONSTRAINT fk_bookcategory_BookISBN FOREIGN KEY (BookISBN) REFERENCES books(BookISBN)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `bookcategory` (`BookCategoryID`, `CategoryID`, `BookISBN`) VALUES
(1, 1, '9786161830342'),
(2, 1, '9786161826567'),
(3, 1, '9786161834043'),
(4, 1, '9786162873829'),
...
(16, 3, '9786162873829');
CREATE TABLE orders(    
  OrderLast int NOT NULL AUTO_INCREMENT, 
  OrderNumber varchar(255) NOT NULL, 
  DateWhen date NOT NULL, 
  TimeWhen time NOT NULL,
  DAndT varchar(40) NOT NULL,
  UserID int(10) NOT NULL, 
  BookISBN varchar(20) NOT NULL,
  OrderAmount int(15) NOT NULL,
  OrderPrice varchar(50) NOT NULL,
  ShippingCost varchar(10) NOT NULL,
  OrderTotal varchar(50) NOT NULL,
  OrderAddress text(10000) NOT NULL,
  KEY (OrderLast,UserID,BookISBN),
  CONSTRAINT fk_userid FOREIGN KEY (UserID) REFERENCES users(UserID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT,
  CONSTRAINT fk_BookISBN FOREIGN KEY (BookISBN) REFERENCES books(BookISBN)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `orders` (`OrderLast`, `OrderNumber`, `DateWhen`, `TimeWhen`, `DAndT`, `UserID`, `BookISBN`, `OrderAmount`, `OrderPrice`, `ShippingCost`, `OrderTotal`, `OrderAddress`) VALUES
(1, 'TH733488078', '2021-01-07', '23:38:28', '2021-01-07 23:38:28', 2, '9786161834043', 1, '584.25', '35', '619.25', 'ศรัณย์ เวียงสิมมา 168 หมู่ 2 บ้านหนองขาม จังหวัด: อ่างทอง อำเภอ: สามโก้ ตำบล: โพธิ์ม่วงพันธ์ 14160 เบอร์ติดต่อ +66 611230387'),
(3, 'TH331906423', '2021-01-07', '23:44:25', '2021-01-07 23:44:25', 4, '9786161826567', 1, '225', '30', '255', 'ร้านขายหนังสือ บ้านทรงไทย จังหวัด: พระนครศรีอยุธยา อำเภอ: นครหลวง ตำบล: ท่าช้าง 13260 เบอร์ติดต่อ +66 677891253'),
(4, 'TH1992820313', '2021-01-07', '23:51:54', '2021-01-07 23:51:54', 4, '9786161834043', 1, '2625.25', '120', '2745.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ +66 34430557'),
(5, 'TH1992820313', '2021-01-07', '23:51:54', '2021-01-07 23:51:54', 4, '9786161826567', 10, '2625.25', '120', '2745.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ +66 34430557'),
(7, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786161826567', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(8, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786161834043', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(9, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786161826567', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(10, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786161826567', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(11, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786161834043', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(12, 'TH120231450', '2021-01-07', '23:58:16', '2021-01-07 23:58:16', 5, '9786162873829', 1, '1634.5', '70', '1704.5', 'พัทธดนย์ วุฒาณิชย์ 25ม.5 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ห้วยขวาง 73140 เบอร์ติดต่อ +66 993416664'),
(13, 'TH1643628419', '2021-01-08', '01:17:01', '2021-01-08 01:17:01', 6, '9786161826567', 1000, '225000', '1500', '226500', 'สราวุธ เวียงสิมมา 168 จังหวัด: นครปฐม อำเภอ: กำแพงแสน ตำบล: ทุ่งขวาง 73140 เบอร์ติดต่อ +66 960328952'),
(14, 'TH7196392785', '2021-04-18', '23:03:54', '2021-04-18 23:03:54', 2, '9786162873829', 1, '1042', '45', '1087', 'ศรัณย์ เวียงสิมมา 168 หมู่ 2 บ้านหนองขาม จังหวัด: อ่างทอง อำเภอ: สามโก้ ตำบล: โพธิ์ม่วงพันธ์ 14160 เบอร์ติดต่อ 611230387'),
(15, 'TH7196392785', '2021-04-18', '23:03:54', '2021-04-18 23:03:54', 2, '9786161834043', 1, '1042', '45', '1087', 'ศรัณย์ เวียงสิมมา 168 หมู่ 2 บ้านหนองขาม จังหวัด: อ่างทอง อำเภอ: สามโก้ ตำบล: โพธิ์ม่วงพันธ์ 14160 เบอร์ติดต่อ 611230387'),
(16, 'TH7196392785', '2021-04-18', '23:03:54', '2021-04-18 23:03:54', 2, '9786161826567', 1, '1042', '45', '1087', 'ศรัณย์ เวียงสิมมา 168 หมู่ 2 บ้านหนองขาม จังหวัด: อ่างทอง อำเภอ: สามโก้ ตำบล: โพธิ์ม่วงพันธ์ 14160 เบอร์ติดต่อ 611230387'),
(17, 'TH7196392785', '2021-04-18', '23:03:54', '2021-04-18 23:03:54', 2, '9786161830342', 1, '1042', '45', '1087', 'ศรัณย์ เวียงสิมมา 168 หมู่ 2 บ้านหนองขาม จังหวัด: อ่างทอง อำเภอ: สามโก้ ตำบล: โพธิ์ม่วงพันธ์ 14160 เบอร์ติดต่อ 611230387'),
(18, 'TH5101921112', '2021-04-19', '10:18:56', '2021-04-19 10:18:56', 1, '9786162873829', 101, '21109', '800', '21909', '  จังหวัด:  อำเภอ:  ตำบล:   เบอร์ติดต่อ '),
(19, 'TH6742596043', '2021-04-19', '10:18:56', '2021-04-19 10:18:56', 4, '9786162873829', 101, '21109', '800', '21909', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(20, 'TH7986242722', '2021-04-19', '12:31:44', '2021-04-19 12:31:44', 1, '9786161826567', 1, '1156', '50', '1206', '  จังหวัด:  อำเภอ:  ตำบล:   เบอร์ติดต่อ '),
(21, 'TH7986242722', '2021-04-19', '12:31:44', '2021-04-19 12:31:44', 1, '9786161830342', 4, '1156', '50', '1206', '  จังหวัด:  อำเภอ:  ตำบล:   เบอร์ติดต่อ '),
(22, 'TH7936972625', '2021-04-19', '19:12:50', '2021-04-19 19:12:50', 1, '9786161830342', 1, '1486.75', '70', '1556.75', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(23, 'TH7936972625', '2021-04-19', '19:12:50', '2021-04-19 19:12:50', 1, '9786162873829', 6, '1486.75', '70', '1556.75', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(24, 'TH8670964834', '2021-04-19', '19:14:28', '2021-04-19 19:14:28', 1, '9786161826567', 1, '1042', '45', '1087', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(25, 'TH8670964834', '2021-04-19', '19:14:28', '2021-04-19 19:14:28', 1, '9786161834043', 1, '1042', '45', '1087', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(26, 'TH8670964834', '2021-04-19', '19:14:28', '2021-04-19 19:14:28', 1, '9786162873829', 1, '1042', '45', '1087', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(27, 'TH8670964834', '2021-04-19', '19:14:28', '2021-04-19 19:14:28', 1, '9786161830342', 1, '1042', '45', '1087', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(28, 'TH9297005982', '2021-04-20', '10:48:34', '2021-04-20 10:48:34', 4, '9786161834043', 1900, '712975', '1500', '714475', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(29, 'TH0875323697', '2021-04-20', '10:55:22', '2021-04-20 10:55:22', 1, '9786161834043', 1900, '712975', '1500', '714475', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(30, 'TH0557995989', '2021-04-20', '11:11:21', '2021-04-20 11:11:21', 4, '9786161834043', 50, '18762.5', '500', '19262.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(31, 'TH8305254686', '2021-04-20', '11:11:23', '2021-04-20 11:11:23', 1, '9786161830342', 1, '18995.25', '500', '19495.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(32, 'TH3050162625', '2021-04-20', '11:23:37', '2021-04-20 11:23:37', 1, '9786161834043', 20, '7714', '200', '7914', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(33, 'TH1574298755', '2021-04-20', '12:01:41', '2021-04-20 12:01:41', 4, '9786161834043', 10, '3752.5', '120', '3872.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(34, 'TH6047012922', '2021-04-20', '12:03:04', '2021-04-20 12:03:04', 1, '9786162873829', 1, '3961.5', '120', '4081.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(35, 'TH6047012922', '2021-04-20', '12:03:04', '2021-04-20 12:03:04', 1, '9786161834043', 10, '3961.5', '120', '4081.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(36, 'TH0166647985', '2021-04-20', '12:09:05', '2021-04-20 12:09:05', 1, '9786161834043', 81, '31062', '500', '31562', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(37, 'TH0166647985', '2021-04-20', '12:09:05', '2021-04-20 12:09:05', 1, '9786162873829', 1, '31062', '500', '31562', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(38, 'TH0166647985', '2021-04-20', '12:09:05', '2021-04-20 12:09:05', 1, '9786161826567', 1, '31062', '500', '31562', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(39, 'TH0166647985', '2021-04-20', '12:09:05', '2021-04-20 12:09:05', 1, '9786161830342', 1, '31062', '500', '31562', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(40, 'TH6446305467', '2021-04-20', '12:09:06', '2021-04-20 12:09:06', 4, '9786162873829', 1, '31062', '500', '31562', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(41, 'TH6446305467', '2021-04-20', '12:09:06', '2021-04-20 12:09:06', 4, '9786161826567', 1, '31062', '500', '31562', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(42, 'TH6446305467', '2021-04-20', '12:09:06', '2021-04-20 12:09:06', 4, '9786161830342', 1, '31062', '500', '31562', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(43, 'TH3893435528', '2021-04-20', '12:11:47', '2021-04-20 12:11:47', 1, '9786162873829', 1, '4419.25', '120', '4539.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(44, 'TH3893435528', '2021-04-20', '12:11:47', '2021-04-20 12:11:47', 1, '9786161834043', 10, '4419.25', '120', '4539.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(45, 'TH3893435528', '2021-04-20', '12:11:47', '2021-04-20 12:11:47', 1, '9786161826567', 1, '4419.25', '120', '4539.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(46, 'TH3893435528', '2021-04-20', '12:11:47', '2021-04-20 12:11:47', 1, '9786161830342', 1, '4419.25', '120', '4539.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(47, 'TH4089118565', '2021-04-20', '12:11:49', '2021-04-20 12:11:49', 4, '9786162873829', 1, '4419.25', '120', '4539.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(48, 'TH4089118565', '2021-04-20', '12:11:49', '2021-04-20 12:11:49', 4, '9786161826567', 1, '4419.25', '120', '4539.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(49, 'TH4089118565', '2021-04-20', '12:11:49', '2021-04-20 12:11:49', 4, '9786161830342', 1, '4419.25', '120', '4539.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(50, 'TH4338332950', '2021-04-20', '12:14:11', '2021-04-20 12:14:11', 1, '9786161834043', 7, '3293.5', '120', '3413.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(51, 'TH4338332950', '2021-04-20', '12:14:11', '2021-04-20 12:14:11', 1, '9786162873829', 1, '3293.5', '120', '3413.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(52, 'TH4338332950', '2021-04-20', '12:14:11', '2021-04-20 12:14:11', 1, '9786161826567', 1, '3293.5', '120', '3413.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(53, 'TH4338332950', '2021-04-20', '12:14:11', '2021-04-20 12:14:11', 1, '9786161830342', 1, '3293.5', '120', '3413.5', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(54, 'TH7429774347', '2021-04-20', '12:14:12', '2021-04-20 12:14:12', 4, '9786161826567', 1, '3293.5', '120', '3413.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(55, 'TH7429774347', '2021-04-20', '12:14:12', '2021-04-20 12:14:12', 4, '9786161830342', 1, '3293.5', '120', '3413.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(56, 'TH7429774347', '2021-04-20', '12:14:12', '2021-04-20 12:14:12', 4, '9786162873829', 1, '3293.5', '120', '3413.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(57, 'TH5982153638', '2021-04-20', '13:04:20', '2021-04-20 13:04:20', 4, '9786162873829', 1, '209', '30', '239', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(58, 'TH9302498398', '2021-04-20', '14:51:08', '2021-04-20 14:51:08', 4, '9786162873829', 1, '209', '30', '239', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(59, 'TH5100253531', '2021-05-02', '13:52:19', '2021-05-02 13:52:19', 4, '9786161834043', 1, '584.25', '35', '619.25', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(60, 'TH2092001194', '2021-05-02', '15:21:51', '2021-05-02 15:21:51', 1, '9786161834043', 1, '375.25', '', '405.25', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(61, 'TH9452038080', '2021-05-02', '16:25:14', '2021-05-02 16:25:14', 1, '9786161826567', 1, '225', '', '255', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(62, 'TH4396694987', '2021-05-03', '18:35:09', '2021-05-03 18:35:09', 4, '9786161826567', 1, '225', '35', '492.75', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(63, 'TH4396694987', '2021-05-03', '18:35:09', '2021-05-03 18:35:09', 4, '9786161830342', 1, '232.75', '35', '492.75', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(64, 'TH8215692998', '2021-05-03', '19:00:05', '2021-05-03 19:00:05', 4, '9786161830342', 1, '232.75', '30', '487.75', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(65, 'TH2165993759', '2021-05-03', '19:06:27', '2021-05-03 19:06:27', 4, '9786161826567', 1, '225', '30', '255', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(66, 'TH6642136450', '2021-05-03', '19:06:40', '2021-05-03 19:06:40', 4, '9786161830342', 2, '465.5', '35', '500.5', 'สุดหล่อ ห่อหมก 39/45 หมู่ที่ 7 บ้านห้วยหนองไหล จังหวัด: อ่างทอง อำเภอ: ป่าโมก ตำบล: สายทอง 14130 เบอร์ติดต่อ 34430557'),
(67, 'TH8708329763', '2021-05-09', '22:19:33', '2021-05-09 22:19:33', 1, '9786161826567', 3, '675', '45', '952.75', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387'),
(68, 'TH8708329763', '2021-05-09', '22:19:33', '2021-05-09 22:19:33', 1, '9786161830342', 1, '232.75', '45', '952.75', 'wae awdaw จังหวัด: กาญจนบุรี อำเภอ: ท่าม่วง ตำบล: บ้านใหม่ 71110 เบอร์ติดต่อ 0611230387');
CREATE TABLE codes(    
  UserID int(10) NOT NULL,                            
  Code varchar(12) NOT NULL,
  NEvent varchar(100) NOT NULL,
  StartCode date NOT NULL,
  EndCode date NOT NULL,
  KEY (UserID),
  CONSTRAINT fk_codes_userid FOREIGN KEY (UserID) REFERENCES users(UserID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE imgprofile(          
  ...
  KEY (UserID),
  CONSTRAINT fk_imgprofile_userid FOREIGN KEY (UserID) REFERENCES users(UserID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE TABLE basket(    
  BasketNumber int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY, 
  UserID int(10) NOT NULL,                            
  BookISBN varchar(20) NOT NULL, 
  BookName varchar(100) NOT NULL,
  BookAuthor varchar(50) NOT NULL,
  BookTranslate varchar(50) NOT NULL,
  BookPrice float(10) NOT NULL,
  BookAmount float(3) NOT NULL,
  PriceTotal float(10) NOT NULL,
  KEY (UserID,BookISBN),
  CONSTRAINT fk_basket_userid FOREIGN KEY (UserID) REFERENCES users(UserID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT,
  CONSTRAINT fk_basket_bookisbn FOREIGN KEY (BookISBN) REFERENCES books(BookISBN)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `basket` (`BasketNumber`, `UserID`, `BookISBN`, `BookName`, `BookAuthor`, `BookTranslate`, `BookPrice`, `BookAmount`, `PriceTotal`) VALUES
(55, 2, '9786161834043', '12 กฎที่ใช้ได้ตลอดชีวิต : 12 Rules For Life', 'Jordan B. Peterson (จอร์แดน บี ปีเตอร์สัน)', 'ธีร์ ทิพกฤต', 375.25, 1, 375.25),
(70, 1, '9786161826567', 'เลิกเป็นคนดี แล้วจะมีความสุข', '(Tokio Godo) โกะโด โทคิโอะ', 'อาคิรา รัตนาภิรัต', 225, 1, 225);
CREATE TABLE address(    
  AddressNB int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY, 
  UserID int(10) NOT NULL,                            
  UserName varchar(120) NOT NULL,
  UserAddress varchar(255) NOT NULL, 
  Province varchar(40) NOT NULL,
  District varchar(40) NOT NULL,
  Sub_District varchar(40) NOT NULL,
  Postal_Code varchar(5) NOT NULL,
  UserPhone varchar(10) NOT NULL,
  KEY (UserID),
  CONSTRAINT fk_address_userid FOREIGN KEY (UserID) REFERENCES users(UserID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `address` (`AddressNB`, `UserID`, `UserName`, `UserAddress`, `Province`, `District`, `Sub_District`, `Postal_Code`, `UserPhone`) VALUES
(1, 2, 'ศรัณย์ เวียงสิมมา', '168 หมู่ 2 บ้านหนองขาม', 'อ่างทอง', 'สามโก้', 'โพธิ์ม่วงพันธ์', '14160', '611230387'),
(2, 3, 'ร้านขายหนังสือ', 'บ้านทรงไทย', 'พระนครศรีอยุธยา', 'นครหลวง', 'ท่าช้าง', '13260', '677891253'),
(3, 4, 'สุดหล่อ ห่อหมก', '39/45 หมู่ที่ 7 บ้านห้วยหนองไหล', 'อ่างทอง', 'ป่าโมก', 'สายทอง', '14130', '34430557'),
(4, 5, 'พัทธดนย์ วุฒาณิชย์', '25ม.5', 'นครปฐม', 'กำแพงแสน', 'ห้วยขวาง', '73140', '993416664'),
(5, 6, 'สราวุธ เวียงสิมมา', '168', 'นครปฐม', 'กำแพงแสน', 'ทุ่งขวาง', '73140', '960328952'),
(6, 1, 'wae', 'awdaw', 'กาญจนบุรี', 'ท่าม่วง', 'บ้านใหม่', '71110', '0611230387');

CREATE TABLE addressselect(    
  UserIDSelect int(10) NOT NULL,                            
  UserNameSelect varchar(120) NOT NULL,
  UserAddressSelect varchar(255) NOT NULL, 
  ProvinceSelect varchar(40) NOT NULL,
  DistrictSelect varchar(40) NOT NULL,
  Sub_DistrictSelect varchar(40) NOT NULL,
  Postal_CodeSelect int(5) NOT NULL,
  UserPhoneSelect varchar(10) NOT NULL,
  KEY (UserIDSelect),
  CONSTRAINT fk_addressSelect_userid FOREIGN KEY (UserIDSelect) REFERENCES users(UserID)
  ON DELETE CASCADE
  ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;
INSERT INTO `addressselect` (`UserIDSelect`, `UserNameSelect`, `UserAddressSelect`, `ProvinceSelect`, `DistrictSelect`, `Sub_DistrictSelect`, `Postal_CodeSelect`, `UserPhoneSelect`) VALUES
(2, 'ศรัณย์ เวียงสิมมา', '168 หมู่ 2 บ้านหนองขาม', 'อ่างทอง', 'สามโก้', 'โพธิ์ม่วงพันธ์', 14160, '611230387'),
(3, 'ร้านขายหนังสือ', 'บ้านทรงไทย', 'พระนครศรีอยุธยา', 'นครหลวง', 'ท่าช้าง', 13260, '677891253'),
(4, 'สุดหล่อ ห่อหมก', '39/45 หมู่ที่ 7 บ้านห้วยหนองไหล', 'อ่างทอง', 'ป่าโมก', 'สายทอง', 14130, '34430557'),
(5, 'พัทธดนย์ วุฒาณิชย์', '25ม.5', 'นครปฐม', 'กำแพงแสน', 'ห้วยขวาง', 73140, '993416664'),
(6, 'สราวุธ เวียงสิมมา', '168', 'นครปฐม', 'กำแพงแสน', 'ทุ่งขวาง', 73140, '960328952'),
(1, 'wae', 'awdaw', 'กาญจนบุรี', 'ท่าม่วง', 'บ้านใหม่', 71110, '0611230387');
