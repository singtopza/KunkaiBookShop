...
<?php require ("../style/header.php"); ?>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                  <a href="../home/mycard.php" class="listboxpf pl-5 fs16" style="background: #FFB000;">ข้อมูลทางการเงิน</a>
                </li>
                <li>
...
<button type="button" id="sidebarCollapse" class="btn btn-info">
    ...
    <span>ซ่อน | แสดง</span>
            ...
            <!--ช่องว่าง เปิด-->
            <h5 class="headerreg text-center pb-5 pt-3">ข้อมูลทางการเงิน</h5>
            </div>
            <!--ช่องว่าง ปิด-->
          </div>
            </div>
