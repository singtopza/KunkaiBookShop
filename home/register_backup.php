...
<?php require ("../style/header_login.php"); ?>
            ...
            <form name="formreg" id="registerform" action="../database/kkregisterdata.php" method="POST" class="needs-validation" novalidate OnSubmit="return fncSubmit();">
            <div class="row">
              <div class="col-6">
                <table>
                  <tr>
            ...
            <br/>
            <center>
            <button class="btn mb-5 mt-2" type="button" id="btnnewreg" data-toggle="modal" data-target="#submitreg" disabled>สมัครสมาชิก</button>
