...
<div class="top-container-fluid bg-warning text-dark sticky-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning text-dark" style="float: left;">
              ...
              <ul class="navbar-nav mr-auto">
                  <li class="nav-item">
                        <a class="nav-link text-dark" href="../console/setting.php">หน้าแรก</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../console/forbook.php">จัดการหนังสือ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../console/booktype.php">การนำเสนอ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../console/forevent.php">จัดการโค้ด</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../console/fororder.php">ออเดอร์ลูกค้า</a>
                    </li>
                  </ul>
              </div>
            </nav> <!--End Nev-->
