...
<?php require ("../style/header.php"); ?>
      <div class="container">
              <p class="homegoods" style="margin-top: 15px;">หนังสือขายดี</p>
              <div class="row">
        <?php
          $sql_book_hotbook = "SELECT * FROM bookcategory INNER JOIN books ON bookcategory.BookISBN = books.BookISBN WHERE bookcategory.CategoryID = 3 ORDER BY BookCategoryID DESC";
