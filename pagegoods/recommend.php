...
<?php require ("../style/header.php"); ?>
      <div class="container">
          <p class="homegoods" style="margin-top: 15px;">หนังสือแนะนำ</p>
          <div class="row">
        <?php
          $sql_book_recommend = "SELECT * FROM bookcategory INNER JOIN books ON bookcategory.BookISBN = books.BookISBN WHERE bookcategory.CategoryID = 1 ORDER BY BookCategoryID DESC";
